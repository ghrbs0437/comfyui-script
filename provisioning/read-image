...
UNET_MODELS=(
    # Krea2 RAW base model (UNETLoader - "UNET Loader - Krea2 RAW")
    "https://huggingface.co/Comfy-Org/Krea-2/resolve/main/diffusion_models/krea2_raw_bf16.safetensors"
    # PiD upscale model (UNETLoader - "PiD Model")
    "https://huggingface.co/Comfy-Org/PixelDiT/resolve/main/diffusion_models/pid_qwenimage_1024_to_4096_4step_bf16.safetensors"
)

# NOTE: This array is added by us - the stock ai-dock template has no text_encoders category.
# The matching provisioning_get_models call is added in provisioning_start() below.
TEXT_ENCODER_MODELS=(
    # Qwen3-VL 4B text encoder (CLIPLoader - load with type = krea2)
    "https://huggingface.co/Comfy-Org/Krea-2/resolve/main/text_encoders/qwen3vl_4b_bf16.safetensors"
)

LORA_MODELS=(
    # Krea2 Turbo lightning LoRA (active, strength 0.6)
    "https://huggingface.co/Comfy-Org/Krea-2/resolve/main/loras/krea2_turbo_lora_rank_64_bf16.safetensors"
    # Krea2 filter-bypass LoRA (active, strength 1.0) - adult/NSFW community LoRA
    "https://huggingface.co/Kutches/Kr3a/resolve/main/krea2filterbypass.safetensors"

    # --- Optional / disabled in the workflow ---
    # snofs_krea_v1: adult/NSFW community LoRA, BYPASSED in the graph (strength 0.1).
    # Uncomment if you enable that LoraLoader node.
    #"https://huggingface.co/diobrando0/krea2_loras_public/resolve/main/snofs_krea_v1.safetensors"
    #
    # my_first_lora_v1.safetensors: placeholder slot for your OWN trained LoRA.
    # There is no public download - drop your own file into models/lora and rename,
    # or bypass that LoraLoader node (CTRL/CMD + B) if you don't use it.
)
...
VAE_MODELS=(
    # Wan2.1 VAE with integrated 2x upscale decoder (VAELoader)
